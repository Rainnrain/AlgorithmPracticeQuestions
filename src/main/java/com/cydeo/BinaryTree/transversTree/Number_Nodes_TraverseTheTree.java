package com.cydeo.BinaryTree.transversTree;
...
public class Number_Nodes_TraverseTheTree {
    ...
    Please implement this method to traverse the tree and return the sum of
    the values (Node.getValue()) of all nodes at the level N in the tree.
